...
const BOOKS_INITIAL = [
    ...
    return (
        ...
        <button
            onClick={onDec}
            className="w-8 h-8 rounded-full border-2 border-pink-300 text-pink-500 hover:bg-pink-50 flex items-center justify-center transition-all"
        >
            <svg
            viewBox="0 0 24 24"
            fill="none"
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto px-6 pt-8">
            <div className="grid grid-cols-12 gap-4 px-4 pb-5 border-b border-gray-300">
            <div className="col-span-6 text-sm font-semibold text-gray-600 uppercase tracking-wider">
                Item
            </div>
            <div className="col-span-2 text-sm font-semibold text-gray-600 uppercase tracking-wider text-center">
                Quantity
            </div>
            <div className="col-span-2 text-sm font-semibold text-gray-600 uppercase tracking-wider text-center">
                Price
            ...
            {cartItems.map((item) => (
                ...
                <div className="grid grid-cols-12 gap-4 p-5 items-center">
                    ...
                    <img
                        src={item.img}
                        alt={item.title}
                        className="w-28 h-36 object-cover rounded-xl shadow-sm flex-shrink-0"
                    />
                    <div className="flex flex-col justify-center gap-1.5">
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed mt-0.5 line-clamp-3">
                        {item.desc}
                        </p>
                        <div className="mt-2">
                        <FreeShipping />
                    ...
                    <button
                        ...
                        className="text-pink-300 hover:text-pink-500 transition-colors p-1.5 hover:bg-pink-50 rounded-lg"
                    >
                        <svg
                        viewBox="0 0 24 24"
                        fill="none"
        ...
        <div className="max-w-4xl mx-auto mt-10 px-6 pb-10">
            <div className="bg-gray-200 rounded-2xl overflow-hidden p-8">
            <div className="grid grid-cols-2 gap-10">
                <div className="flex flex-col gap-5 border-r border-gray-300 pr-10">
                <div>
